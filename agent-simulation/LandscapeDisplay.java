...
/**
 * Displays a Landscape graphically using Swing. The Landscape contains a grid
 * which can be displayed at any scale factor.
 * 
 * @author bseastwo
 */
public class LandscapeDisplay {
    ...
    private class LandscapePanel extends JPanel {
        ...
        /**
         * Method overridden from JComponent that is responsible for drawing components
         * on the screen. The supplied Graphics object is used to draw.
         * 
