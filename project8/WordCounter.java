...
public class WordCounter {
    ...
    public int getCount (String word){
        Object count = this.map.get(word);
        if (count == null){
            return 0;
        }
        return (int) count;
    ...
    public double getFrequency(String word){
        float frequency = (float) this.getCount(word)/getTotalWordCount();
        return frequency;
    }
    ...
    // call addToHeap method in BST
    public void addToPQ (PQHeap <KeyValuePair<String,Integer>> h){
        BSTMap<String, Integer> bst = (BSTMap <String, Integer>) this.map;
        bst.addToHeap(h);
    }

    // returns the entryset of BST
    public ArrayList <KeyValuePair<String, Integer>> getEntrySet (){
